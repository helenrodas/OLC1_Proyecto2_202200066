...
%start INICIO_PR 
%%
INICIO_PR: INSTRUCCIONES EOF                      {   console.log($1);    }    // imprime el resultado de las instrucciones
;
INSTRUCCIONES : INSTRUCCIONES INSTRUCCION       { $1.push($2); $$ = $1;}
                | INSTRUCCION                     { $$ = [$1]; }
;
...
;
EVALUAR : INTEGER  EXPRESION IGUALACION EXPRESION PUNTO_COMA       {   $$ = $2; console.log($1);  console.log($4);  }
;
